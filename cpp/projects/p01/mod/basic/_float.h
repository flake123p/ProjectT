...
/*
    ...
    Ref: 
        ...
        https://moocaholic.medium.com/fp64-fp32-fp16-bfloat16-tf32-and-other-members-of-the-zoo-a1ca7897d407
                ...
                Total Bits  Sign Bit    Exp Bits        Fraction Bits
    BF16        16          1           8               7
    TF32        19          1           8               10
    half        16          1           5               10
    float       32          1           8               23
...
struct FloatCell {
    ...
    void dump_hex_fields(int newLine = 1) {
        printf("[%-25s] ", __func__);
        printf("0x%lX, ", (long unsigned int)sign);
        printf("0x%lX, ", (long unsigned int)expo);
    ...
    void dump_fields(int newLine = 1) {
        int expoReal = ((int)expo) - expoCmpl;
        printf("[%-25s] ", __func__);
        printf("%d, ", (int)sign);
        printf("%d, ", expoReal);
        printf("0x%lX, ", (long unsigned int)frac);
