...
unsigned char train_image_char[NUM_TRAIN][SIZE784];
unsigned char test_image_char[NUM_TEST][SIZE784];
...
void load_mnist()
{
    ...
    read_mnist_image_char(TEST_IMAGE, NUM_TEST, LEN_INFO_IMAGE, SIZE784, test_image_char, info_image);
    image_char2double(NUM_TEST, test_image_char, test_image);
    
    read_mnist_label_char(TRAIN_LABEL, NUM_TRAIN, LEN_INFO_LABEL, 1, train_label_char, info_label);
    label_char2int(NUM_TRAIN, train_label_char, train_label);
    
    read_mnist_label_char(TEST_LABEL, NUM_TEST, LEN_INFO_LABEL, 1, test_label_char, info_label);
...
int mnist_for_c_example(void)
{
    ...
    // print_mnist_pixel(test_image, 2);
