...
typedef struct __attribute__((packed)) {
    uint8_t core_busy[2]; // bit x 10 cores
    uint8_t core_op[10];
...
int main() 
{
    ...
    FILE *fp = fopen("timing00.bin", "wb");    // hexdump timing00.bin -v -e '/1 "%02x\n"'
