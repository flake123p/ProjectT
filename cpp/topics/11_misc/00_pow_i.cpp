...
int main() 
{
    ...
    }
    {
        ...
        std::chrono::duration<double> elapsed_seconds = end - start;
        double t = elapsed_seconds.count() * 1000; // t number of seconds, represented as a `double`
        printf("t = %13.6f ms [gsl_pow_int 7]\n", t);
    }
    {
        start = std::chrono::steady_clock::now();
        {
        ...
        std::chrono::duration<double> elapsed_seconds = end - start;
        double t = elapsed_seconds.count() * 1000; // t number of seconds, represented as a `double`
        printf("t = %13.6f ms [gsl_pow_uint 7]\n", t);
    }
    {
        start = std::chrono::steady_clock::now();
        {
        ...
        std::chrono::duration<double> elapsed_seconds = end - start;
        double t = elapsed_seconds.count() * 1000; // t number of seconds, represented as a `double`
        printf("t = %13.6f ms [my_pow_uint 7]\n", t);
    }
    // printf("%f\n", my_pow_uint(2.1, 7));
    // printf("%f\n", gsl_pow_uint(2.1, 7));
...

    {
        ...
        std::chrono::duration<double> elapsed_seconds = end - start;
        double t = elapsed_seconds.count() * 1000; // t number of seconds, represented as a `double`
        printf("t = %13.6f ms [torch_powi 7 (unsigned)]\n", t);
    }
