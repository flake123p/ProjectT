'''
By  antonpaquin : https://github.com/antonpaquin/SystolicArrayDemo/blob/master/systolic.py
'''
...
if 0:
    ...
    '''
    https://www.youtube.com/watch?v=oswGZwb5Dcw&ab_channel=Youn-LongLin
